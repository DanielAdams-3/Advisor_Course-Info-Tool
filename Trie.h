...
class Trie{
    ...
    public:
        ...
        //server-specific function call for topics-based autocomplete - also calls startsWithPrefix
        vector<string> autocompleteTopics(const string& prefix, size_t max_results);
